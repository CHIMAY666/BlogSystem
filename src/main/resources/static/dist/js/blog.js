...
function search() {
    ...
    //数据封装
    let searchData = {keyword: keyword};
    let jq_grid = $("#jqGrid");
    //传入查询条件参数
    jq_grid.jqGrid("setGridParam", {postData: searchData});
    //点击搜索按钮默认都从第一页开始
    jq_grid.jqGrid("setGridParam", {page: 1});
    //提交post并刷新表格
    jq_grid.jqGrid("setGridParam", {url: '/admin/blogs/list'}).trigger("reloadGrid");
}
